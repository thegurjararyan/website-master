...
class MembershipHandler {
    ...
    private function initializeDatabase(): void {
        ...
        try {
            ...
            $this->sendResponse(false, 'Database connection failed: ' . $e->getMessage(), null);
        }
    }
    ...
    public function processMembership(): void {
        if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
            $this->sendResponse(false, 'Invalid request method', null);
        }
        ...
        try {
            ...
            $sql = "INSERT INTO members (
                ...
                interest, other_interest, created_at
            ) VALUES (
                :member_id, :name, :contact, :email, :blood_group, :profession,
                :house_number, :lane, :city, :state, :pincode,
                :interest, :other_interest, NOW()
            )";
            ...
            $this->sendResponse(false, 'Database error: ' . $e->getMessage(), null);
        } catch (Exception $e) {
