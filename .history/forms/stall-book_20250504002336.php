    ...
    <div class="container">
        <div class="card p-6">
            ...
            <form id="stallForm" action="process_stall_form.php" method="POST" class="space-y-4">
                ...
                <div>
                    <label class="block text-gray-700 font-semibold text-sm">Business/Organization Name *</label>
                    <input type="text" required name="businessName" class="form-input mt-1 block w-full" />
                ...
                <div>
                    ...
                    <select required name="stallSize" class="form-input mt-1 block w-full">
                        ...
                        <option value="small">Small (8x8 ft) - ₹5,000</option>
                        <option value="medium">Medium (10x10 ft) - ₹8,000</option>
                        <option value="large">Large (12x12 ft) - ₹12,000</option>
                    </select>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <input type="text" required name="addressLine1" placeholder="Address Line 1" 
