...
<head>
    ...
    <title>Volunteering Section</title>
...
<body class="text-gray-800">
    <div class="container">
        <div class="card p-6">
            <h2 class="text-3xl font-bold text-[#ed1f24] mb-4">Volunteer With Us</h2>
            <form id="volunteerForm" action="process_volunteer_form.php" method="POST" class="space-y-4">
                ...
                <div>
                    <label class="block text-gray-700 font-semibold text-sm">Age *</label>
                    <input type="number" required name="age" min="15" max="70" class="form-input mt-1 block w-full" />
                    <span class="error-message">Age must be between 15 and 70</span>
                </div>

                <div>
                    <label class="block text-gray-700 font-semibold text-sm">Occupation *</label>
                    <input type="text" required name="occupation" class="form-input mt-1 block w-full" />
                ...
                <div>
                    <label class="block text-gray-700 font-semibold text-sm">Areas of Interest *</label>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-2 mt-1">
                        <div class="flex items-center">
                            <input type="checkbox" name="interests[]" value="event" class="mr-2" />
                            <span>Event Management</span>
                        </div>
                        <div class="flex items-center">
                            <input type="checkbox" name="interests[]" value="social" class="mr-2" />
                            <span>Social Media</span>
                        </div>
                        <div class="flex items-center">
                            <input type="checkbox" name="interests[]" value="fundraising" class="mr-2" />
                            <span>Fundraising</span>
                        </div>
                        <div class="flex items-center">
                            <input type="checkbox" name="interests[]" value="teaching" class="mr-2" />
                            <span>Teaching/Mentoring</span>
                        </div>
                        <div class="flex items-center">
                            <input type="checkbox" name="interests[]" value="photography" class="mr-2" />
                    ...
                    <span class="error-message">Please select at least one area of interest</span>
                </div>

                <div>
                    <label class="block text-gray-700 font-semibold text-sm">Availability *</label>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-2 mt-1">
                        <div class="flex items-center">
                            <input type="checkbox" name="availability[]" value="weekday_morning" class="mr-2" />
                            <span>Weekday Mornings</span>
                        </div>
                        <div class="flex items-center">
                            <input type="checkbox" name="availability[]" value="weekday_afternoon" class="mr-2" />
                            <span>Weekday Afternoons</span>
                        </div>
                        <div class="flex items-center">
                            <input type="checkbox" name="availability[]" value="weekday_evening" class="mr-2" />
                            <span>Weekday Evenings</span>
                        </div>
                        <div class="flex items-center">
                            <input type="checkbox" name="availability[]" value="weekend_morning" class="mr-2" />
                            <span>Weekend Mornings</span>
                        </div>
                        <div class="flex items-center">
                            <input type="checkbox" name="availability[]" value="weekend_afternoon" class="mr-2" />
                            <span>Weekend Afternoons</span>
                        </div>
                        <div class="flex items-center">
                            <input type="checkbox" name="availability[]" value="weekend_evening" class="mr-2" />
                            <span>Weekend Evenings</span>
                        </div>
                    </div>
                    <span class="error-message">Please select at least one availability option</span>
                </div>

                <div>
                    <label class="block text-gray-700 font-semibold text-sm">Why do you want to volunteer with us? *</label>
                    <textarea required name="motivation" class="form-input mt-1 block w-full" rows="3" 
                        placeholder="Tell us why you're interested in volunteering..."></textarea>
                    <span class="error-message">Please share your motivation</span>
                </div>

                <div>
                    <label class="block text-gray-700 font-semibold text-sm">Any previous volunteering experience?</label>
                    <textarea name="experience" class="form-input mt-1 block w-full" rows="3" 
                        placeholder="Share your previous volunteering experience (if any)..."></textarea>
                </div>
    ...
    <script>
        document.getElementById('volunteerForm').addEventListener('submit', function(e) {
            ...
            const interestsError = document.querySelector('input[name="interests[]"]').closest('div').nextElementSibling;
            
            if (interests.length === 0) {
                interestsError.classList.add('visible');
                valid = false;
            } else {
                interestsError.classList.remove('visible');
            }
            
            const availability = document.querySelectorAll('input[name="availability[]"]:checked');
            const availabilityError = document.querySelector('input[name="availability[]"]').closest('div').nextElementSibling;
            ...
            if (valid) {
                fetch('process_volunteer_form.php', {
                    method: 'POST',
